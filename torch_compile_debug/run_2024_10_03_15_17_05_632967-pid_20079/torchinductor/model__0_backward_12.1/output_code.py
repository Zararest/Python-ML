...
cpp_fused_add_div_mul_neg_pow_select_backward_sub_0 = async_compile.cpp_pybinding(['const float*', 'const float*', 'const float*', 'const float*', 'const float*', 'float*', 'float*', 'float*'], '''
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    sub_3 = rand_strided((), (), device='cpu', dtype=torch.float32)
    tangents_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    fn = lambda: call([primals_1, primals_2, primals_3, sub_3, tangents_1])
