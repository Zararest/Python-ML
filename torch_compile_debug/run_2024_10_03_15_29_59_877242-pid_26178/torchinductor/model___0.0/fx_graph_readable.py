class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[2]", arg1_1: "f32[]", arg2_1: "f32[]", arg3_1: "f32[]", arg4_1: "f32[]"):
        ...
        select_scatter: "f32[2]" = torch.ops.aten.select_scatter.default(full, add_7, 0, 1);  add_7 = None
        select_scatter_1: "f32[2]" = torch.ops.aten.select_scatter.default(full, add_8, 0, 0);  full = add_8 = None
        add_9: "f32[2]" = torch.ops.aten.add.Tensor(select_scatter, select_scatter_1);  select_scatter = select_scatter_1 = None
